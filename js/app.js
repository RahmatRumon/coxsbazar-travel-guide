...
// ──────────────────────────────────────────
//  Google Maps URLs (Fixed Template Literals)
// ──────────────────────────────────────────
function getViewUrl(spot) {
  if (spot.cid) {
    return `https://maps.google.com/?cid=${spot.cid}`;
  } 
  else {
    return `https://maps.google.com/?q=${spot.lat},${spot.lon}`;
  }
}
